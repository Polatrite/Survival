...
//
		...
		"Wood Craft" = list(
			...
			new/craftable("Wooden Pole", "A very versatile small pole.",
				/obj/game/item/components/pole/wooden_pole, 1,
				"woodworking", 1, 0, 9, list(),
				list(/:materials/lumber = 4), icon('obj1.dmi', "medium wooden pole")),
		...
		"Smithing" = list(
			...
			new/craftable("Iron Shovel", "A crude shovel made of iron.",
				...
				list(/:metal/iron/iron_bar = 10, /:components/pole = 1), icon('obj1.dmi', "iron shovel")),
			new/craftable("Iron Hoe", "A crude hoe made of iron.",
				...
				list(/:metal/iron/iron_bar = 20, /:components/pole = 1), icon('obj1.dmi', "iron hoe")),
			...
			new/craftable("Iron Pickaxe", "A crude pickaxe made of iron.",
				...
				list(/:metal/iron/iron_bar = 15, /:components/pole = 1), icon('obj1.dmi', "iron pickaxe")),
			new/craftable("Iron Axe", "A crude axe made of iron.",
				...
				list(/:metal/iron/iron_bar = 12, /:components/pole = 1), icon('obj1.dmi', "iron axe")),
			...
			new/craftable("Reinforced Iron Shovel", "A sturdy shovel made of iron.",
				...
				list(/:metal/iron/iron_bar = 20, /:components/pole = 2), icon('obj1.dmi', "reinforced iron shovel")),
			new/craftable("Reinforced Iron Hoe", "A sturdy hoe made of iron.",
				...
				list(/:metal/iron/iron_bar = 40, /:components/pole = 2), icon('obj1.dmi', "reinforced iron hoe")),
			...
			new/craftable("Reinforced Iron Pickaxe", "A sturdy pickaxe made of iron.",
				...
				list(/:metal/iron/iron_bar = 30, /:components/pole = 2), icon('obj1.dmi', "reinforced iron pickaxe")),
			...
			new/craftable("Reinforced Iron Axe", "A sturdy axe made of iron.",
				...
				list(/:metal/iron/iron_bar = 24, /:components/pole = 2), icon('obj1.dmi', "reinforced iron axe")),
			new/craftable("Iron Spear", "A heavy spear made of iron.",
				...
				list(/:metal/iron/iron_bar = 50, /:components/pole = 2), icon('obj2.dmi', "spear")),
			),
		...
		"Masonry" = list(
			...
			new/craftable("Ceremic Brick Kiln", "A kiln made of bricks. Used to fire bricks and wood to strengthen them.",
				...
				list(/:brick/clay_brick = 300, /:components/pole = 8), icon('obj1.dmi', "brick kiln"), BUILD_ON_FLOOR),
...
var/list/resourceNames = list(
	...
	/:components/pole = "Small Wooden Pole",
	/:components/pole = "Medium Wooden Pole",
	/:components/pole = "Large Wooden Pole",
	)
